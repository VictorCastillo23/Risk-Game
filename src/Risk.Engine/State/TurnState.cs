...
/// end-of-turn card draw, awarded in a later PR), whether they have already
/// used their once-per-turn <c>FortifyCommand</c>, and any conquest still
/// awaiting an <c>OccupyCommand</c>. Both per-turn flags are reset to
/// <see langword="false"/> whenever <c>EndPhaseCommand</c> rotates the turn
/// to the next player.
/// </summary>

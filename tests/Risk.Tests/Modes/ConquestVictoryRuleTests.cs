...
public class ConquestVictoryRuleTests
{
    private static readonly IVictoryRule Rule = new ConquestVictoryRule();
        ...
        PlayerId? currentPlayer = null)
    {
        ...
        return new GameState(
            territories, players, turn, Deck.CreateStandard(), [], new GameStatus.InProgress(), Mode: GameMode.Classic);
    }
}
